...
```
elysd config chain-id elysarchive-1
...
```
elysd init <YOUR_MONIKER> --chain-id elysarchive-1
```
...
sed -i 's/seeds = ""/seeds = "ade4d8bc8cbe014af6ebdf3cb7b1e9ad36f412c0@archive-seeds.polkachu.com:22056"/' ~/.elys/config/config.toml
```
...
<a href="https://service./archive/elys/cheat" 
>
