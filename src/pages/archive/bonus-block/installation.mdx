...
```
 Genesis
```
curl https://bonusblock-archive.alter.network/genesis? | jq '.result.genesis' > ~/.bonusblock/config/genesis.json
```
...
seeds="e5e04918240cfe63e20059a8abcbe62f7eb05036@bonusblock-archive-p2p.alter.network:26656"
...
<a href="https://service.sychonix.com/mainnet/bonusblock-archive/cheat" 
>
