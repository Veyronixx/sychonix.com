...
and update it from:
```
FROM elixirprotocol/validator:archive-1
...
- Claim your ELXR (If you were part of archive V1 you would be eligible to receive ELXR). If you need Goerli ETH, you can ask in the [Discord server](https://discord.gg/puzc28Xq).
