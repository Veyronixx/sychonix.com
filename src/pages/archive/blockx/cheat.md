...
--amount=<span class="ramount1"></span>0000000abcx \
...
<pre class="my-pre"> blockxd tx slashing unjail --broadcast-mode=block --from <span class="rwallet10">  </span> --chain-id blockx_100-1 --gas="1000000" --gas-prices="0abcx"
</pre>
...
<pre class="my-pre"> blockxd tx distribution withdraw-all-rewards --from <span class="rwallet12"></span> --chain-id blockx_100-1 --gas="1000000" --gas-prices="0abcx"</pre>

<label for="ivalidator" style="vertical-align: top;">2. Withdraw commission and rewards from your validator</label>
<pre class="my-pre"> blockxd tx distribution withdraw-rewards $(blockxd keys show <span class="rwallet13"></span> --bech val -a) --commission --from <span class="rwallet14"></span> --chain-id blockx_100-1 --gas="1000000" --gas-prices="0abcx" --gas-prices="0abcx"</pre>
...
<label for="idelegetet" style="vertical-align: top;">3. Delegate tokens to yourself</label>
 ...
 <pre class="my-pre" id="pre1" style="margin-top: 5px;">blockxd tx staking delegate $(blockxd keys show <span class="rwallet15"></span> --bech val -a) <span class="rdelegete1"></span>00000000abcx --from <span class="rwallet16"></span> --chain-id blockx_100-1 --gas="1000000" --gas-prices="0abcx"  </pre>
...
<label for="iredelegetet" style="vertical-align: top;">4. Redelegate tokens to another validator</label>
 ...
 <pre class="my-pre" id="pre1" style="margin-top: 5px;"> blockxd tx staking redelegate $(blockxd keys show <span class="rwallet17"></span> --bech val -a) <span class="rredelegete1"></span> <span class="rdelegete2"></span>00000000abcx --from <span class="rwallet18"></span> --chain-id blockx_100-1 --gas="1000000" --gas-prices="0abcx"
</pre>

<label for="iredelegetet" style="vertical-align: top;">5. Delegate tokens to validator</label>
 <pre class="my-pre" id="pre1" style="margin-top: 5px;"> blockxd tx staking delegate <span class="rredelegete2"></span> <span class="rdelegete3"></span>00000000abcx --from <span class="rwallet19"></span> --chain-id blockx_100-1 --gas="1000000" --gas-prices="0abcx"
 </pre>

<label for="iredelegetet" style="vertical-align: top;">6. Unbond tokens from your validator</label>
 <pre class="my-pre" id="pre1" style="margin-top: 5px;"> blockxd tx staking unbond $(blockxd keys show <span class="rwallet20"></span> --bech val -a) <span class="rdelegete4"></span>00000000abcx --from <span class="rwallet21"></span> --chain-id blockx_100-1 --gas="1000000" --gas-prices="0abcx"
</pre>
</div>
...
blockxd tx bank send<span class="rwallet22"></span> <span class="rtoken1"></span> <span class="rdelegete5"></span>000000000abcx --from <span class="rwallet23"></span> --chain-id blockx_100-1 --gas="1000000" --gas-prices="0abcx"
</pre></div>
