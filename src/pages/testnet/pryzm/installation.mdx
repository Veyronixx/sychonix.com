...
```
 ...
 Genesis
```
wget -O genesis.json https://snapshots.polkachu.com/testnet-genesis/pryzm/genesis.json --inet4-only
mv genesis.json ~/.pryzm/config
```
 Addrbook 
```
wget -O addrbook.json https://snapshots.polkachu.com/testnet-addrbook/pryzm/addrbook.json --inet4-only
