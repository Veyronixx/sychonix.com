...
<div class="pre-container">
  <pre class="my-pre" id="pre1" style="margin-top: 5px;">selfchaind keys add <span class="rwallet1"></span></pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre2" style="margin-top: 5px;">selfchaind keys add <span class="rwallet2"></span> --recover</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre3" style="margin-top: 5px;">selfchaind keys list <span class="rwallet3"></span></pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre4">selfchaind keys delete <span class="rwallet4"></span></pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre5">selfchaind keys export <span class="rwallet5"></span></pre>
...
<div class="pre-container">
<pre class="my-pre" id="pre6">selfchaind keys import <span class="rwallet6"></span>.backup</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre7">selfchaind q bank balances $(selfchaind keys show <span class="rwallet7"></span> -a)</pre>
...
--amount=<span class="ramount1">1000000uself</span> \
...
<div class="pre-container">
  <pre class="my-pre" id="pre10">selfchaind tx slashing unjail --from wallet --chain-id selfchain-testnet --gas auto --gas-adjustment 1.5  </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre11">selfchaind query slashing signing-info $(selfchaind tendermint show-validator)</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre12">selfchaind q staking validator $(selfchaind keys show wallet --bech val -a)</pre>
  <button class="copy-btn" id="copy12" data-clipboard-text="" onclick="copyText(12)"></button>
</div>

<label> Get Denom Info</label>
<div class="pre-container">
  <pre class="my-pre" id="pre23">selfchaind q bank denom-metadata -oj | jq</pre>
  <button class="copy-btn" id="copy23" data-clipboard-text="" onclick="copyText(23)"></button>
</div>

<label> Get Sync Status</label>
<div class="pre-container">
  <pre class="my-pre" id="pre24">selfchaind status 2>&1 | jq -r '.SyncInfo.catching_up // .sync_info.catching_up'</pre>
  <button class="copy-btn" id="copy24" data-clipboard-text="" onclick="copyText(24)"></button>
</div>

<label> Get Latest Height</label>
<div class="pre-container">
  <pre class="my-pre" id="pre25">selfchaind status 2>&1 | jq -r '.SyncInfo.latest_block_height // .sync_info.latest_block_height'</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre13">selfchaind tx distribution withdraw-all-rewards --from wallet --chain-id selfchain-testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.005uself -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre14">selfchaind tx distribution withdraw-rewards $(selfchaind keys show wallet --bech val -a) --commission --from wallet --chain-id selfchain-testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.005uself -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre15" style="margin-top: 5px;">selfchaind tx staking delegate $(selfchaind keys show wallet --bech val -a) <span class="rdelegete1"></span>1000000uself --from wallet --chain-id selfchain-testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.005uself -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre16" style="margin-top: 5px;">selfchaind tx staking redelegate $(selfchaind keys show wallet --bech val -a) <span class="rredelegete1"></span> <span class="rdelegete2"></span>1000000uself --from wallet --chain-id selfchain-testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.005uself -y</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre17" style="margin-top: 5px;">selfchaind tx staking delegate <span class="rredelegete2"></span> <span class="rdelegete3"></span>1000000uself --from <span class="rwallet19"></span> --chain-id selfchain-testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.005uself -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre18" style="margin-top: 5px;">selfchaind tx staking unbond $(selfchaind keys show wallet --bech val -a) <span class="rdelegete4"></span>1000000uself --from wallet --chain-id selfchain-testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.005uself -y</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre19" style="margin-top: 5px;">selfchaind tx bank send wallet</span> <span class="rtoken1"></span> <span class="rdelegete5"></span>1000000uself --from wallet --chain-id selfchain-testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.005uself -y</pre>
...
sed -i.bak -e "s%^address = \"tcp://0.0.0.0:1317\"%address = \"tcp://0.0.0.0:${CUSTOM_PORT}317\"%; s%^address = \":8080\"%address = \":${CUSTOM_PORT}080\"%; s%^address = \"0.0.0.0:9090\"%address = \"0.0.0.0:${CUSTOM_PORT}090\"%; s%^address = \"0.0.0.0:9091\"%address = \"0.0.0.0:${CUSTOM_PORT}091\"%" $HOME/.selfchain/config/app.toml</pre>
  <button class="copy-btn" id="copy20" data-clipboard-text="" onclick="copyText(20)"></button>
</div>

<label> Remove Node</label>
<div class="pre-container">
  <pre class="my-pre" id="pre21">cd $HOME && sudo systemctl stop selfchaind && sudo systemctl disable selfchaind && sudo rm /etc/systemd/system/selfchaind.service && sudo systemctl daemon-reload && sudo rm -rf $(which selfchaind) && sudo rm -rf $HOME/.selfchain && sudo rm -rf $(which selfchaind)</pre>
...
<script>
  function updatePre() {
   ...
   const detailsInput = document.getElementById('idetails').value.trim();
    ...
    document.querySelector('.ramount1').textContent = amountInput + 'uself'; 
