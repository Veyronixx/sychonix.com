...
<div class="dashboard-overview p-6 bg-gray-900 rounded-lg mb-2">
  <div class="flex flex-col items-center">
    <img src="/img/tern.png" alt="Logo" class="dashboard-logo mb-2 w-24 h-24 rounded-full" />
    <h2 class="text-xl font-bold text-white mb-1">T3rn</h2>
    <p class="text-left text-sm text-gray-300 mb-1">
T3rn is a modular interoperability platform that enables fast, secure, and cost-effective cross-chain exchanges. t3rn connects various blockchains, makes it easy for users to exchange assets, and rewards infrastructure providers (Executors) through efficient execution of cross-network transactions.</p>
  </div>
</div>
