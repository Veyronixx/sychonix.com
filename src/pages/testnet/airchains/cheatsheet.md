...
<div class="pre-container">
  <pre class="my-pre" id="pre10">junctiond tx slashing unjail --from <span class="rwallet10"></span> --chain-id junction --gas-prices 0.00025amf --gas-adjustment 1.5 --gas auto -y</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre12">junctiond q staking validator $(junctiond keys show <span class="rwallet11"></span> --bech val -a)</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre13">junctiond tx distribution withdraw-all-rewards --from <span class="rwallet12"></span> --chain-id junction --gas=auto  --gas-prices="0amf"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre14">junctiond tx distribution withdraw-rewards $(junctiond keys show <span class="rwallet13"></span> --bech val -a) --commission --from <span class="rwallet14"></span> --chain-id junction --gas=auto --gas-prices="0amf"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre15" style="margin-top: 5px;">junctiond tx staking delegate $(junctiond keys show <span class="rwallet15"></span> --bech val -a) <span class="rdelegete1"></span>00000000amf --from <span class="rwallet16"></span> --chain-id junction --gas=auto --gas-prices="0amf"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre16" style="margin-top: 5px;">junctiond tx staking redelegate $(junctiond keys show <span class="rwallet17"></span> --bech val -a) <span class="rredelegete1"></span> <span class="rdelegete2"></span>00000000amf --from <span class="rwallet18"></span> --chain-id junction --gas=auto --gas-prices="0amf"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre17" style="margin-top: 5px;">junctiond tx staking delegate <span class="rredelegete2"></span> <span class="rdelegete3"></span>00000000amf --from <span class="rwallet19"></span> --chain-id junction --gas=auto --gas-prices="0amf"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre18" style="margin-top: 5px;">junctiond tx staking unbond $(junctiond keys show <span class="rwallet20"></span> --bech val -a) <span class="rdelegete4"></span>00000000amf --from <span class="rwallet21"></span> --chain-id junction --gas=auto --gas-prices="0amf"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre19" style="margin-top: 5px;">junctiond tx bank send <span class="rwallet22"></span> <span class="rtoken1"></span> <span class="rdelegete5"></span>000000000amf --from <span class="rwallet23"></span> --chain-id junction --gas=auto --gas-prices="0amf"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre21">sudo systemctl stop junctiond && sudo systemctl disable junctiond && sudo rm /etc/systemd/system/junctiond.service && sudo systemctl daemon-reload && rm -rf $HOME/.junction && rm -rf junction && sudo rm -rf $(which junctiond)</pre>
