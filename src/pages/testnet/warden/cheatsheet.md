...
<div class="pre-container">
  <pre class="my-pre" id="pre1" style="margin-top: 5px;">wardend keys add <span class="rwallet1"></span></pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre2" style="margin-top: 5px;">wardend keys add <span class="rwallet2"></span> --recover</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre3" style="margin-top: 5px;">wardend keys list <span class="rwallet3"></span></pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre4">wardend keys delete <span class="rwallet4"></span></pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre5">wardend keys export <span class="rwallet5"></span></pre>
...
<div class="pre-container">
<pre class="my-pre" id="pre6">wardend keys import <span class="rwallet6"></span>.backup</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre7">wardend q bank balances $(wardend keys show <span class="rwallet7"></span> -a)</pre>
...
--amount=<span class="ramount1">1000000award</span> \
...
<div class="pre-container">
  <pre class="my-pre" id="pre10">wardend tx slashing unjail --from wallet --chain-id chiado_10010-1 --gas auto --gas-adjustment 1.5  </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre11">wardend query slashing signing-info $(wardend tendermint show-validator)</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre12">wardend q staking validator $(wardend keys show wallet --bech val -a)</pre>
  <button class="copy-btn" id="copy12" data-clipboard-text="" onclick="copyText(12)"></button>
</div>

<label> Get Denom Info</label>
<div class="pre-container">
  <pre class="my-pre" id="pre23">wardend q bank denom-metadata -oj | jq</pre>
  <button class="copy-btn" id="copy23" data-clipboard-text="" onclick="copyText(23)"></button>
</div>

<label> Get Sync Status</label>
<div class="pre-container">
  <pre class="my-pre" id="pre24">wardend status 2>&1 | jq -r '.SyncInfo.catching_up // .sync_info.catching_up'</pre>
  <button class="copy-btn" id="copy24" data-clipboard-text="" onclick="copyText(24)"></button>
</div>

<label> Get Latest Height</label>
<div class="pre-container">
  <pre class="my-pre" id="pre25">wardend status 2>&1 | jq -r '.SyncInfo.latest_block_height // .sync_info.latest_block_height'</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre13">wardend tx distribution withdraw-all-rewards --from wallet --chain-id chiado_10010-1 --gas auto --gas-adjustment 1.5 --gas-prices 25000000award -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre14">wardend tx distribution withdraw-rewards $(wardend keys show wallet --bech val -a) --commission --from wallet --chain-id chiado_10010-1 --gas auto --gas-adjustment 1.5 --gas-prices 25000000award -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre15" style="margin-top: 5px;">wardend tx staking delegate $(wardend keys show wallet --bech val -a) <span class="rdelegete1"></span>1000000award --from wallet --chain-id chiado_10010-1 --gas auto --gas-adjustment 1.5 --gas-prices 25000000award -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre16" style="margin-top: 5px;">wardend tx staking redelegate $(wardend keys show wallet --bech val -a) <span class="rredelegete1"></span> <span class="rdelegete2"></span>1000000award --from wallet --chain-id chiado_10010-1 --gas auto --gas-adjustment 1.5 --gas-prices 25000000award -y</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre17" style="margin-top: 5px;">wardend tx staking delegate <span class="rredelegete2"></span> <span class="rdelegete3"></span>1000000award --from <span class="rwallet19"></span> --chain-id chiado_10010-1 --gas auto --gas-adjustment 1.5 --gas-prices 25000000award -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre18" style="margin-top: 5px;">wardend tx staking unbond $(wardend keys show wallet --bech val -a) <span class="rdelegete4"></span>1000000award --from wallet --chain-id chiado_10010-1 --gas auto --gas-adjustment 1.5 --gas-prices 25000000award -y</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre19" style="margin-top: 5px;">wardend tx bank send wallet</span> <span class="rtoken1"></span> <span class="rdelegete5"></span>1000000award --from wallet --chain-id chiado_10010-1 --gas auto --gas-adjustment 1.5 --gas-prices 25000000award -y</pre>
...
sed -i.bak -e "s%^address = \"tcp://0.0.0.0:1317\"%address = \"tcp://0.0.0.0:${CUSTOM_PORT}317\"%; s%^address = \":8080\"%address = \":${CUSTOM_PORT}080\"%; s%^address = \"0.0.0.0:9090\"%address = \"0.0.0.0:${CUSTOM_PORT}090\"%; s%^address = \"0.0.0.0:9091\"%address = \"0.0.0.0:${CUSTOM_PORT}091\"%" $HOME/.warden/config/app.toml</pre>
  <button class="copy-btn" id="copy20" data-clipboard-text="" onclick="copyText(20)"></button>
</div>

<label> Remove Node</label>
<div class="pre-container">
  <pre class="my-pre" id="pre21">cd $HOME && sudo systemctl stop wardend && sudo systemctl disable wardend && sudo rm /etc/systemd/system/wardend.service && sudo systemctl daemon-reload && sudo rm -rf $(which wardend) && sudo rm -rf $HOME/.warden && sudo rm -rf $(which wardend)</pre>
...
<script>
  function updatePre() {
   ...
   const detailsInput = document.getElementById('idetails').value.trim();
    ...
    document.querySelector('.ramount1').textContent = amountInput + 'award'; 
