...
<div class="pre-container">
  <pre class="my-pre" id="pre21">cd $HOME && sudo systemctl stop achillesd && sudo systemctl disable achillesd && sudo rm /etc/systemd/system/achillesd .service && sudo systemctl daemon-reload && sudo rm -rf $(which achillesd ) && sudo rm -rf $HOME/.atomone && sudo rm -rf $(which achillesd )</pre>
