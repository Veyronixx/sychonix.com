...
--amount=<span class="ramount1">1000000uslf</span> \
...
<div class="pre-container">
  <pre class="my-pre" id="pre10">selfchaind tx slashing unjail --from wallet --chain-id self-1 --gas auto --gas-adjustment 1.5  </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre13">selfchaind tx distribution withdraw-all-rewards --from wallet --chain-id self-1 --gas auto --gas-adjustment 1.5 --gas-prices 1uslf -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre14">selfchaind tx distribution withdraw-rewards $(selfchaind keys show wallet --bech val -a) --commission --from wallet --chain-id self-1 --gas auto --gas-adjustment 1.5 --gas-prices 1uslf -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre15" style="margin-top: 5px;">selfchaind tx staking delegate $(selfchaind keys show wallet --bech val -a) <span class="rdelegete1"></span>1000000uslf --from wallet --chain-id self-1 --gas auto --gas-adjustment 1.5 --gas-prices 1uslf -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre16" style="margin-top: 5px;">selfchaind tx staking redelegate $(selfchaind keys show wallet --bech val -a) <span class="rredelegete1"></span> <span class="rdelegete2"></span>1000000uslf --from wallet --chain-id self-1 --gas auto --gas-adjustment 1.5 --gas-prices 1uslf -y</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre17" style="margin-top: 5px;">selfchaind tx staking delegate <span class="rredelegete2"></span> <span class="rdelegete3"></span>1000000uslf --from <span class="rwallet19"></span> --chain-id self-1 --gas auto --gas-adjustment 1.5 --gas-prices 1uslf -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre18" style="margin-top: 5px;">selfchaind tx staking unbond $(selfchaind keys show wallet --bech val -a) <span class="rdelegete4"></span>1000000uslf --from wallet --chain-id self-1 --gas auto --gas-adjustment 1.5 --gas-prices 1uslf -y</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre19" style="margin-top: 5px;">selfchaind tx bank send wallet</span> <span class="rtoken1"></span> <span class="rdelegete5"></span>1000000uslf --from wallet --chain-id self-1 --gas auto --gas-adjustment 1.5 --gas-prices 1uslf -y</pre>
...
<script>
  function updatePre() {
   ...
   const detailsInput = document.getElementById('idetails').value.trim();
    ...
    document.querySelector('.ramount1').textContent = amountInput + 'uslf'; 
