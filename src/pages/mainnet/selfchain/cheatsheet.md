...
<div class="pre-container">
  <pre class="my-pre" id="pre21">sudo systemctl stop selfchaind && sudo systemctl disable selfchaind && sudo rm /etc/systemd/system/selfchaind.service && sudo systemctl daemon-reload && rm -rf $HOME/.selfchain && rm -rf mineplex-mainnet-1 && sudo rm -rf $(which selfchaind)</pre>
