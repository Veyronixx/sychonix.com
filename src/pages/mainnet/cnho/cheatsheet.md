...
--amount=<span class="ramount1">1000000ucnho</span> \
...
<div class="pre-container">
  <pre class="my-pre" id="pre10">cnhod tx slashing unjail --from wallet --chain-id cnho_stables-1 --gas auto --gas-adjustment 1.5  </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre12">cnhod q staking validator $(cnhod keys show wallet --bech val -a)</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre13">cnhod tx distribution withdraw-all-rewards --from wallet --chain-id cnho_stables-1 --gas auto --gas-adjustment 1.5 --gas-prices 0.00001ucnho -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre14">cnhod tx distribution withdraw-rewards $(cnhod keys show wallet --bech val -a) --commission --from wallet --chain-id cnho_stables-1 --gas auto --gas-adjustment 1.5 --gas-prices 0.00001ucnho -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre15" style="margin-top: 5px;">cnhod tx staking delegate $(cnhod keys show wallet --bech val -a) <span class="rdelegete1"></span>1000000ucnho --from wallet --chain-id cnho_stables-1 --gas auto --gas-adjustment 1.5 --gas-prices 0.00001ucnho -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre16" style="margin-top: 5px;">cnhod tx staking redelegate $(cnhod keys show wallet --bech val -a) <span class="rredelegete1"></span> <span class="rdelegete2"></span>1000000ucnho --from wallet --chain-id cnho_stables-1 --gas auto --gas-adjustment 1.5 --gas-prices 0.00001ucnho -y</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre17" style="margin-top: 5px;">cnhod tx staking delegate <span class="rredelegete2"></span> <span class="rdelegete3"></span>1000000ucnho --from <span class="rwallet19"></span> --chain-id cnho_stables-1 --gas auto --gas-adjustment 1.5 --gas-prices 0.00001ucnho -y </pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre18" style="margin-top: 5px;">cnhod tx staking unbond $(cnhod keys show wallet --bech val -a) <span class="rdelegete4"></span>1000000ucnho --from wallet --chain-id cnho_stables-1 --gas auto --gas-adjustment 1.5 --gas-prices 0.00001ucnho -y</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre19" style="margin-top: 5px;">cnhod tx bank send wallet</span> <span class="rtoken1"></span> <span class="rdelegete5"></span>1000000ucnho --from wallet --chain-id cnho_stables-1 --gas auto --gas-adjustment 1.5 --gas-prices 0.00001ucnho -y</pre>
...
<script>
  function updatePre() {
   ...
   const detailsInput = document.getElementById('idetails').value.trim();
    ...
    document.querySelector('.ramount1').textContent = amountInput + 'ucnho'; 
