...
<div class="pre-container">
  <pre class="my-pre" id="pre1" style="margin-top: 5px;">cnhod keys add <span class="rwallet1"></span></pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre2" style="margin-top: 5px;">cnhod keys add <span class="rwallet2"></span> --recover</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre3" style="margin-top: 5px;">cnhod keys list <span class="rwallet3"></span></pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre4">cnhod keys delete <span class="rwallet4"></span></pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre5">cnhod keys export <span class="rwallet5"></span></pre>
...
<div class="pre-container">
<pre class="my-pre" id="pre6">cnhod keys import <span class="rwallet6"></span>.backup</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre7">cnhod q bank balances $(cnhod keys show <span class="rwallet7"></span> -a)</pre>
...
--amount=<span class="ramount1"></span>0000000ucnho \
...
cnhod tx staking edit-validator \
...
<div class="pre-container">
  <pre class="my-pre" id="pre10">cnhod tx slashing unjail --from <span class="rwallet10"></span> --chain-id cnho_stables-1 --gas-prices 0.00025ucnho --gas-adjustment 1.5 --gas auto -y</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre11">cnhod query slashing signing-info $(cnhod tendermint show-validator)</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre12">cnhod q staking validator $(cnhod keys show <span class="rwallet11"></span> --bech val -a)</pre>
  <button class="copy-btn" id="copy12" data-clipboard-text="" onclick="copyText(12)"></button>
</div>

<label> Get Denom Info</label>
<div class="pre-container">
  <pre class="my-pre" id="pre23">cnhod q bank denom-metadata -oj | jq</pre>
  <button class="copy-btn" id="copy23" data-clipboard-text="" onclick="copyText(23)"></button>
</div>

<label> Get Sync Status</label>
<div class="pre-container">
  <pre class="my-pre" id="pre24">cnhod status 2>&1 | jq -r '.SyncInfo.catching_up // .sync_info.catching_up'</pre>
  <button class="copy-btn" id="copy24" data-clipboard-text="" onclick="copyText(24)"></button>
</div>

<label> Get Latest Height</label>
<div class="pre-container">
  <pre class="my-pre" id="pre25">cnhod status 2>&1 | jq -r '.SyncInfo.latest_block_height // .sync_info.latest_block_height'</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre13">cnhod tx distribution withdraw-all-rewards --from <span class="rwallet12"></span> --chain-id cnho_stables-1 --gas=auto  --gas-prices="0ucnho"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre14">cnhod tx distribution withdraw-rewards $(cnhod keys show <span class="rwallet13"></span> --bech val -a) --commission --from <span class="rwallet14"></span> --chain-id cnho_stables-1 --gas=auto --gas-prices="0ucnho"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre15" style="margin-top: 5px;">cnhod tx staking delegate $(cnhod keys show <span class="rwallet15"></span> --bech val -a) <span class="rdelegete1"></span>00000000ucnho --from <span class="rwallet16"></span> --chain-id cnho_stables-1 --gas=auto --gas-prices="0ucnho"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre16" style="margin-top: 5px;">cnhod tx staking redelegate $(cnhod keys show <span class="rwallet17"></span> --bech val -a) <span class="rredelegete1"></span> <span class="rdelegete2"></span>00000000ucnho --from <span class="rwallet18"></span> --chain-id cnho_stables-1 --gas=auto --gas-prices="0ucnho"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre17" style="margin-top: 5px;">cnhod tx staking delegate <span class="rredelegete2"></span> <span class="rdelegete3"></span>00000000ucnho --from <span class="rwallet19"></span> --chain-id cnho_stables-1 --gas=auto --gas-prices="0ucnho"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre18" style="margin-top: 5px;">cnhod tx staking unbond $(cnhod keys show <span class="rwallet20"></span> --bech val -a) <span class="rdelegete4"></span>00000000ucnho --from <span class="rwallet21"></span> --chain-id cnho_stables-1 --gas=auto --gas-prices="0ucnho"</pre>
...
<div class="pre-container">
  <pre class="my-pre" id="pre19" style="margin-top: 5px;">cnhod tx bank send <span class="rwallet22"></span> <span class="rtoken1"></span> <span class="rdelegete5"></span>000000000ucnho --from <span class="rwallet23"></span> --chain-id cnho_stables-1 --gas=auto --gas-prices="0ucnho"</pre>
...
sed -i.bak -e "s%^proxy_app = \"tcp://127.0.0.1:26658\"%proxy_app = \"tcp://127.0.0.1:${CUSTOM_PORT}658\"%; s%^laddr = \"tcp://127.0.0.1:26657\"%laddr = \"tcp://127.0.0.1:${CUSTOM_PORT}657\"%; s%^pprof_laddr = \"localhost:6060\"%pprof_laddr = \"localhost:${CUSTOM_PORT}060\"%; s%^laddr = \"tcp://0.0.0.0:26656\"%laddr = \"tcp://0.0.0.0:${CUSTOM_PORT}656\"%; s%^prometheus_listen_addr = \":26660\"%prometheus_listen_addr = \":${CUSTOM_PORT}660\"%" $HOME/.cnho/config/config.toml
sed -i.bak -e "s%^address = \"tcp://0.0.0.0:1317\"%address = \"tcp://0.0.0.0:${CUSTOM_PORT}317\"%; s%^address = \":8080\"%address = \":${CUSTOM_PORT}080\"%; s%^address = \"0.0.0.0:9090\"%address = \"0.0.0.0:${CUSTOM_PORT}090\"%; s%^address = \"0.0.0.0:9091\"%address = \"0.0.0.0:${CUSTOM_PORT}091\"%" $HOME/.cnho/config/app.toml</pre>
