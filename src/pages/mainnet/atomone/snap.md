...
<script>
  async function fetchSnapshotInfo() {
    try {
      const response = await fetch('https://snapshot.sychonix.com/mainnet/atomone/log.json');
...
<div class="code-block-wrapper">
  <pre><code>aria2c -x 16 -s 16 -o atomone-snapshot.tar.lz4 https://snapshot.sychonix.com/mainnet/atomone/atomone-snapshot.tar.lz4
